...
<!-- Mirrored from olaf-admin.envytheme.com/ui-elements/forms by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jan 2020 14:35:23 GMT -->
<!-- Added by HTTrack -->
    ...
    <div class="sidemenu-area">
        ...
        <div class="sidemenu-body">
            <ul class="sidemenu-nav metisMenu h-100" id="sidemenu-nav" data-simplebar>
                ...
                <li class="nav-item">
                    <a href="#" class="collapsed-nav-link nav-link collapsed-nav" aria-expanded="false">
                        <span class="icon">
                ...
                <li class="nav-item-title">UI Elements</li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sidemenu-nav-second-level">
                        ...
                        <li class="nav-item ">
                            <a href="../../icons/feathericons.html" class="nav-link">
                                <span class="icon"><i class='bx bx-right-arrow-alt'></i></span>
                ...
                <li class="nav-item ">
                    <a href="../../pages/blank-page.html" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="sidemenu-nav-second-level">
                        <li class="nav-item ">
                            <a href="../../miscellaneous/not-authorized.html" class="nav-link">
                        ...
                        <li class="nav-item ">
                            <a href="../../miscellaneous/not-authorized-with-image.html" class="nav-link">
                        ...
                        <li class="nav-item ">
                            <a href="../../miscellaneous/maintenance.html" class="nav-link">
                        ...
                        <li class="nav-item ">
                            <a href="../../miscellaneous/maintenance-with-image.html" class="nav-link">
                        ...
                        <li class="nav-item ">
                            <a href="../../miscellaneous/coming-soon.html" class="nav-link">
                        ...
                        <li class="nav-item ">
                            <a href="../../miscellaneous/coming-soon-with-image.html" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sidemenu-nav-third-level">
                                <li class="nav-item ">
                                    <a href="../../error/error-404.html" class="nav-link">
                                ...
                                <li class="nav-item ">
                                    <a href="../../error/error-404-with-image.html" class="nav-link">
                                ...
                                <li class="nav-item ">
                                    <a href="../../error/error-500.html" class="nav-link">
                                ...
                                <li class="nav-item ">
                                    <a href="../../error/error-500-with-image.html" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="sidemenu-nav-second-level">
                        <li class="nav-item ">
                            <a href="../../charts/apex-charts.html" class="nav-link">
                                <span class="icon"><i class='bx bx-right-arrow-alt'></i></span>
                ...
                <li class="nav-item ">
                    <a href="../../pages/maps.html" class="nav-link">
    ...
    <div class="main-content d-flex flex-column">
        ...
        <nav class="navbar top-navbar navbar-expand">
            <div class="collapse navbar-collapse" id="navbarSupportContent">
                ...
                <ul class="navbar-nav left-nav align-items-center">
                    <li class="nav-item">
                        <a href="../../app/email/inbox.html" class="nav-link" data-toggle="tooltip"
                    ...
                    <li class="nav-item">
                        <a href="../../app/chat.html" class="nav-link" data-toggle="tooltip" data-placement="bottom"
                            title="Message">
        ...
        <div class="card mb-30">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3>Stages Of Completion</h3>
            </div>

            <div class="card-body">
                
                <form method="POST" action="#" enctype="multipart/form" class="mt-5">
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="amount_spent">Amount Spent</label>
                            <input type="text" class="form-control" id="amount_spent" name="amount_spent">
                        ...
                        <div class="form-group col-md-4">
                            <label for="spent_details">Details of Amount Spent</label>
                            <input type="text" class="form-control" id="amount_details"
                                name="amount_details">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="work_done">Photos of Work Done</label>
                            <input type="file" class="form-control" id="photo_work_done" name="photo_work_done">
                     ...
                     <div class="form-row">
                        <div class="form-group col-md-4">
                            <input type="hidden" class="form-control" id="stage_name" name="stage_name" value="">
                        </div>
                        <div class="form-group col-md-2">

                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary bx-pull-right">Save</button>
                </form>
            </div>
        </div>
