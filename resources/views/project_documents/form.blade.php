...
<div class="row">
    <div class="col col-4">
        <div class="custom-control custom-checkbox mb-3">
            ...
            <select class="custom-select" required name="is_document_ready">
...
<div class="col col-4">
    <div class="custom-control custom-radio">
        ...
        <select class="custom-select" required name="is_document_submitted">
            <option value="">Open this select menu</option>
            <option value="1">One</option>
            <option value="2">Two</option>
            <option value="3">Three</option>
...
<div class="row">
    <div class="col col-4">
        <div class="custom-control custom-radio mb-3">
            ...
            <select class="custom-select" required name="is_document_prepared">
                <option value="">Open this select menu</option>
                <option value="1">One</option>
                <option value="2">Two</option>
                <option value="3">Three</option>
