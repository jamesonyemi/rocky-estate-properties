                    ...
                    <tbody>
                      <tr>
                        <td align="left" valign="top" style="font-size: 16px; padding: 0 50px">
                            ...
                            <tbody>
                              <tr>
                                <td align="center" valign="middle" style="padding: 0; ">
                                  ...
                                  <h1 style="font-size: 24px; font-weight: 600; margin: 0; text-align: center">Please login with your email and password</h1>
                          ...
                          </table><span style="font-weight: 600"> <i18n-string data-key="account.verifyUserEmailAddress.ifNewSignupText" data-locale-at-render="en-us">Thanks for signing up to {!! config('app.name') !!}, . We’re happy to have you.</i18n-string> </span>
                          <p style="margin: 0">
                            <i18n-string data-key="account.verifyUserEmailAddress.bodyText" data-locale-at-render="en-us">Please take a second to login with the credentials below:</i18n-string><br><br>
                            <i18n-string data-key="account.verifyUserEmailAddress.bodyText" data-locale-at-render="en-us">Email: {!! $recipient_email !!}</i18n-string><br>
                            <i18n-string data-key="account.verifyUserEmailAddress.bodyText" data-locale-at-render="en-us">Password: {!! $recipient_secretKey !!}</i18n-string>
                          </p>
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 0; height: 50px; width: 100%; min-width: 100%; line-height: 0;">
                            <tbody>
                              <tr>
                              ...
                              <tr>
                                <td align="center">
                                  <table border="0" cellspacing="0" cellpadding="0">
                                    <tbody>
                                      <tr>
                                        <td align="center" style="border-radius: 3px;" bgcolor="#425b76" width="auto"><a href="{!! $url !!}"
                                            target="_blank" style="border: 1px solid #425b76; border-radius: 3px; color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 500; line-height: 1; padding: 12px 20px; text-decoration: none; width: auto; min-width: 170px; white-space: nowrap; ">Sign In</a></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </td>
                              ...
                              <tr>
                                <td align="center" valign="middle" style="padding: 0; ">
                                  <p style="font-size: 14px; margin: 0">
                                    {{-- <i18n-string data-key="account.verifyUserEmailAddress.noSignupHelp" data-locale-at-render="en-us">Didn't sign up for {!! config('app.name') !!}? <a href="{!! $url !!}"
                      ...
                      <tr>
                        <td align="center" valign="top">
                          <table cellpadding="0" border="0" cellspacing="0" width="100%" style="color: #425b76; background-color: ; font-size: 14px; width: 100%; margin: initial; min-width: 100%; line-height: 24px">
                            <tbody>
                              <tr>
                                <td align="center" valign="middle" style="padding: 20px 0 65px; ">{!! config('app.name') !!}, Inc.<br>25 First Street, 2nd Floor<br>Cambridge, MA 02141</td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
