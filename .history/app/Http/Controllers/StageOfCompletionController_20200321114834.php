    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('img_name')) {
            ...
            foreach ($files as $key => $file) {
                ...
                $file_name           =  date("Y-m-d_h_i_s") . "_" . $file->getClientOriginalName();
                // $imageData           =  base64_encode(Storage::putFileAs('stage_of_completion_img',$file_name,$file_name));
                $path = $file->getClientOriginalName()->storeAs('stage_of_completion_img',$file->getClientOriginalName());
                ddd($path);
