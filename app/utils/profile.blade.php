    ...
    <section class="profile-area">
        <div class="profile-header mb-30">
            <div class="user-profile-images">
                <img src="../assets/img/profile-banner.jpg" class="cover-image" alt="image">
                            ...
                            <div class="col-lg-8">
                                <div class="post-share-content mb-30">
                                    <div class="post-share-field">
                                        <label><img src="../assets/img/user1.jpg" alt="image"></label>
                                    ...
                                    <div class="card mb-30">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <div class="timeline-story-header d-flex align-items-center">
                                                <img src="../assets/img/user1.jpg" width="50" height="50" class="rounded-circle" alt="image">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            <li class="d-flex align-items-center">
                                <img src="../assets/img/user2.jpg" width="70" height="70" class="rounded-circle" alt="image">
                            ...
                            <li class="d-flex align-items-center">
                                <img src="../assets/img/user3.jpg" width="70" height="70" class="rounded-circle" alt="image">
                            ...
                            <li class="d-flex align-items-center">
                                <img src="../assets/img/user4.jpg" width="70" height="70" class="rounded-circle" alt="image">
                            ...
                            <li class="d-flex align-items-center">
                                <img src="../assets/img/user5.jpg" width="70" height="70" class="rounded-circle" alt="image">
